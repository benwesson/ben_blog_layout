...
export default function Navbar() {
	...
	return (
		<nav className={styles.header} aria-label="Site navigation Bar">
			<p className={styles.titleText} aria-label="Page Title: Ben's Eats">
				{"Ben's Eats"}
			</p>

			<div className={styles.navbar} aria-label="Primary navigation links">
			...
			>
				<Link href="/" aria-label="Go to home page from mobile menu">
					Home
				</Link>

				<Link href="/recipes" aria-label="Browse all recipes from mobile menu">
					Recipes
				</Link>

				<Link href="/post" aria-label="Create a new post from mobile menu">
					Post
				</Link>
